    ...
    function html5Upload() {	
    	...
    	sUploadURL= '/DLink/HTML/js/smarteditor2/sample/photo_uploader/file_uploader_html5.jsp'; 	//upload URL
	...
	function onAjaxError (){
 	...
 	function callFileUploader (){
 	   ...
 	   //     sCallback : location.href.replace(/\/[^\/]*$/, '') + '/callback.html',	//업로드 이후에 iframe이 redirect될 콜백페이지의 주소
 			sUrl  : '/DLink/HTML/js/smarteditor2/sample/photo_uploader/file_uploader.jsp' ,
 			sCallback : '/DLink/HTML/js/smarteditor2/sample/photo_uploader/callback.html' ,

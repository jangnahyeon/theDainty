	...
	<div class="bd_top_type02">
		...
		<table class="bd_tbl center">
			...
			<colgroup>
				<col width="7%">
				<col width="17%">
				<c:if test="${searchVO.code eq '0003' }"><col width="17%"></c:if>
				<col width="17%">
				<col width="17%">
				<col width="7%">
				<col width="7%">
			...
			<thead>
				<tr>
					...
					<c:if test="${searchVO.code eq '0003' }"><th scope="col" class="">업체명</th></c:if>
			...
			<tbody>
				<c:forEach var="result" items="${resultList}" varStatus="status">
					<tr>
						...
						<c:if test="${searchVO.code eq '0003' }"><td>${result.comNm}</td></c:if>
						<td>${result.memNm}</td>
						<td>${result.regDt}</td>
						<td>										
						<span class="bd_btn">

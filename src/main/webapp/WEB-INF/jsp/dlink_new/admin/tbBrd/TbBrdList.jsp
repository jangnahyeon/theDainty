			...
			<fieldset class="search_form">
				...
				<div class="sel_box">										
					...
					<form:select path="searchCondition" id="sel_area">
							...
							<option value="srcNm">메뉴타입</option>
					</form:select>
					</div>
				</div>
				<div class="bd_sel_search">
					...
					<form:input path="searchKeyword" style="color: rgb(163, 163, 163);" onkeypress="enterkey()" onkeyup="javascript:enterkey();" id="searchKeyword" maxlength="20"/>
...
<!-- 				<div class="bd_sel_search">
		...
		<table class="bd_tbl bd_biz center">
			...
			<c:forEach var="result" items="${resultList}" varStatus="status">
				...
				<tr>
	 				<td><a href="javascript:fn_egov_select('<c:out value="${result.brdSeq}"/>')"><fmt:formatNumber type="number" maxFractionDigits="0"  value="${result.rn }" /></a>&nbsp;</td>

					...
					<table class="tbl_basic center">
						...
						<tbody>
							<tr>
								...
								<td>
									<strong class="dis_block f_size25 cl_blue">무료</strong>
								</td>
								<td>-</td>
								<td>-</td>
								<td rowspan="2" class="no_border">-</td>
							</tr>
						</tbody>
					</table>
				</section>
				...
				<section class="info_cont mb30">
					...
					<div class="cont_box">
						<ul class="list_type01">
							...
							<li>지원 대상 : <strong style="font-weight:bolder">제주도내 중소기업 및 소상공인 (제조업)</strong></li>
							<li>사용 시간 : 기본 3시간</li>
							...
							<li>예약 후 부득이한 상황으로 취소를 원하시는 경우, 촬영예정일 기준 최소 7일 전에 전화로 취소 바랍니다.</li>
							<li>촬영예정일 기준 당일~6일 전 예약 취소, 변경 시 6개월간 이용에 제한이 있습니다.</li>
						</ul>
					</div>
					...
					<div class="cont_box">
						<ul class="list_type01">
							<li>촬영 결과물은 jpg, png 파일 제공을 기본으로 하며, 촬영일 기준 2주 이내 마이페이지의 시설예약 관리 페이지를 통해 제공됩니다.</li>
							<li>사용자의 데이터는 제공일 기준 30일간 보관 후 순차적으로 폐기됩니다.</li>
							<li>결과물의 저작권은 제주 디자인 스튜디오와 공동으로 소유합니다.</li>
							<li>본 스튜디오에서 촬영한 사진, 영상 등의 콘텐츠는 제주 디자인 스튜디오의 홍보에 사용될 수 있습니다.</li>
						</ul>
					</div>
					<p class="tit">4) 셀프 스튜디오 이용 유의사항 </p>
					<div class="cont_box">
						<ul class="list_type01">
							<li>운영 시간 : 월~금 / 09:00~18:00 (공휴일 제외)</li>
							<li>지원 대상 : 제주 디자인 스튜디오 촬영 장비 교육 수료자</li>
							<li>사용 시간 : 최대 2시간</li>
							<li>사용 기준 : 월 2회 이내</li>
							<li>스튜디오 일정에 따라 예약일이 변동될 수 있습니다.</li>
							<li>예약 후 부득이한 상황으로 취소나 변경을 원하시는 경우 이용예정일 기준 최소 7일 전에 전화로 취소 바랍니다.</li>
							<li>이용예정일 기준 당일~6일 전 예약 취소, 변경 시 6개월간 이용에 제한이 있습니다.</li>
							<li>촬영 결과물을 저장할 수 있는 개인 SD카드를 꼭 지참하시기 바랍니다.</li>
							<li>장비 및 비품은 운영자가 세팅한 상태에서 사용해야 합니다.</li>
							<li>촬영에 필요한 소품들은 모두 직접 준비하셔야 하며 본 스튜디오는 사용자의 물품과 장비, 데이터에 대한 관리 책임이 없습니다.</li>
							<li>스튜디오에서 물 이외의 음식물 취식을 금합니다.</li>
							<li>촬영용 음식물 반입 시 운영진의 동의를 필하여야 하며 잔여 음식물 및 포장재는 직접 처리하여야 합니다.</li>
							<li>시설 운영규칙 위반 시에는 당일 및 추후 이용을 제한할 수 있습니다.</li>
							<li>본 스튜디오에서 촬영한 결과물은 제주 디자인 스튜디오 채널(홈페이지, SNS 등)에 게재될 수 있습니다.</li>
						</ul>
					</div>
				</section>

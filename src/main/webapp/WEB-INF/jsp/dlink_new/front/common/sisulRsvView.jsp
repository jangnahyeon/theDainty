			...
			<div class="innerwrap">	
				...
				<c:if test="${rsv.sisulSeq == 1}">		
					...
					<div class="view_top">
						...
						<span class="date"><b>작성일</b><span>${rsv.regDt}</span></span>
					...
					<div class="view_content">	
						...
						<ul class="view_list">
							<li>
								<div class="tit_box"><b>예약구분</b></div>
								<div class="txt_box">
									<c:forEach var="codelist" items="${codelist}">
										<c:if test="${codelist.gbCd == 'plt008'}">
											<c:if test="${codelist.code ==  rsv.rsvGbCd}">	
												<p>${codelist.codeNm }</p>
											</c:if>
										</c:if>
									</c:forEach>
						...
						<c:if test="${rsv.prod2 != ''}">
							...
							<li>
								...
								<div class="txt_box">
									<p>- ${fn:replace(rsv.purposeCd, ',', '</br>- ')}</p>
								</div>
							</li>
							<li>
								<div class="tit_box"><b>중소기업확인서 첨부파일</b></div>
								<div class="txt_box">
							...
							<li>
								<div class="tit_box"><b>납기본 다운로드</b></div>
								<div class="txt_box">
									<ul class="list_type01">
										<li><a href="/imagefile/download.do?file_no=${rsv.zipFileSeq}" class="ellipsis" target="_blank" onchange="">${rsv.zipFileNm}</a></li>
									</ul>
								</div>
							</li>
						</ul>

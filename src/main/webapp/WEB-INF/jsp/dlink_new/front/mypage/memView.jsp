...
function fn_join_act() {
	...
	$("#email").val( email );
<c:if test="${frontLoginVO.code ne '0003' }">
	if( !fn_validate("#memNm", "이름을") ) {
		return;
	}
</c:if>
						...
						<div class="wirte_container_con_inner">	
							...
							<c:if test="${frontLoginVO.code eq '0003' }">
								<div class="wirte_container">
									...
									<div class="wirte_content">
										<div class="wirte_content_inner">
											<input type="text" name="comNm" value="${frontLoginVO.comNm }" id="comNm" required="" class="input01" size="10" maxlength="20">
										</div>
									</div>
								</div>
										...
										<div class="wirte_content_inner">
											<div class="gourp_inp ">        
												<div class=" item_filter">
													<input type="text" size="" class="txt w40" name="comNo" value="${frontLoginVO.comNo }" maxlength="12" id="comNo" oninput="regexComNumber(this);">
												</div>
											</div>
										</div>
									</div>
								...
								<div class="wirte_container">
									...
									<div class="wirte_content">
										<div class="wirte_content_inner">
											<input type="text" name="memNm" value="${frontLoginVO.memNm }" id="memNm" required="" class="input01" size="10" maxlength="20">
										</div>
									</div>
								</div>
								...
								<div class="wirte_container">
									...
									<div class="wirte_content">
										<div class="wirte_content_inner">
											<input type="text" name="damdangNm" value="${frontLoginVO.damdangNm }" id="damdangNm" required="" class="input01" size="10" maxlength="20">
										</div>
									</div>
								</div>
							</c:if>
							...
							<div class="wirte_container">
								...
								<div class="wirte_content">
									<div class="wirte_content_inner">
										<input type="text" name="birth" value="${frontLoginVO.birth }" id="birth" required="" class="input01" size="10" maxlength="8">
									</div>
								</div>
							</div>
								...
								<div class="wirte_content">
									<div class="wirte_content_inner">
										<ul class="gender_radio">
											<li><input type="radio" name="comType" id="comType1" value="C" <c:if test="${frontLoginVO.comType eq 'C' }">checked</c:if>><label for="comType1" class="">중소기업</label></li>
											<li><input type="radio" name="comType" id="comType2" value="D" <c:if test="${frontLoginVO.comType eq 'D' }">checked</c:if>><label for="comType2" class="">디자인전문회사</label></li>
										</ul>
									</div>
								</div>
							</div>

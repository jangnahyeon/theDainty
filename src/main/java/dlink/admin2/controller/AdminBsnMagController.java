...
public class AdminBsnMagController {
	...
	public String popMagMdf(
			...
			HttpServletResponse response)
			throws Exception{
		return "/admin2/bsnMag/popMagMdf";
	}

...
<%
 /**
  * @Class Name : TbCodeList.jsp
  * @Description : TbCode List 화면
...
function fn_egov_addView() {
   	document.getElementById("listForm").action = "<c:url value='/admin/tbCode/addTbCodeView.do'/>";
   	document.getElementById("listForm").submit();		
}
...
function fn_egov_link_page(pageNo){
	...
	document.getElementById("listForm").action = "<c:url value='/admin/code/codeList.do'/>";
   	document.getElementById("listForm").submit();
}
	...
	<div id="table">
					...
					<div class="sel_box">										
						...
						<div>
							<select id="searchCondition" name="searchCondition">
								...
								<option value="gbNm">구분코드명</option>	
		...
		<table class="bd_tbl bd_biz center">
			...
			<c:forEach var="result" items="${resultList}" varStatus="status">
				<tr>	 				
					<td align="center" class="listtd"><c:out value="${result.gbCd}"/>&nbsp;</td>
					<td align="center" class="listtd"><c:out value="${result.codeGbVO.gbNm}"/>&nbsp;</td>
					<td align="center" class="listtd"><a href="javascript:fn_egov_select('<c:out value="${result.code}"/>', '<c:out value="${result.gbCd}"/>')"><c:out value="${result.code}"/></a>&nbsp;</td>

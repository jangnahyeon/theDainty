	...
	<div class="main_visual_wrap">
		<div class="swiper m_visual">
		  <div class="swiper-wrapper">
			...
			<div class="swiper-slide">
				<a href="#m_visualZone">
					<span class="m_visual_thum"><img src="/DLink/HTML_2023/images/main/main_thum_visual02.jpg" alt=""></span>
					<span class="m_visual_text studio"><strong>제주 디자인 스튜디오</strong><em>전문 작가를 통해 제품이 돋보이는 <br>사진 촬영 서비스를 제공합니다.</em></span>
				</a>
			</div>
			<div class="swiper-slide">
				<a href="#m_visualZone">
					<span class="m_visual_thum"><img src="/DLink/HTML_2023/images/main/main_thum_visual03.jpg" alt=""></span>
					<span class="m_visual_text bank"><strong>디자인 뱅크</strong><em>도내 중·소상공인 누구나 활용할 수 있는<br> 패키지디자인 소스를 제공합니다.</em></span>
				</a>
			</div>
		  </div>

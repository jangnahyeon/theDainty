...
<%
 /**
  * @Class Name : TbPortfRegister.jsp
  * @Description : TbPortf Register 화면
...
<c:set var="registerFlag" value="${empty tbPortfVO.portfSeq || 0 eq tbPortfVO.portfSeq ? '등록' : '수정'}"/>			
...
<!-- validator:javascript formName="tbPortfVO" staticJavascript="false" xhtml="true" cdata="false"/ -->

<script type="text/javaScript" language="javascript" defer="defer">
//<!--
/* 글 목록 화면 function */
function fn_egov_selectList() {
   	document.getElementById("detailForm").action = "<c:url value='/admin/tbPortf/TbPortfList.do'/>";
   	document.getElementById("detailForm").submit();		
}

/* 글 삭제 function */
function fn_egov_delete() {
   	document.getElementById("detailForm").action = "<c:url value='/admin/tbPortf/deleteTbPortf.do'/>";
   	document.getElementById("detailForm").submit();		
}
...
function fn_egov_save() {	
	...
	/* TODO Validation기능 보완 */
  	...
  	frm.action = "<c:url value="${registerFlag == '등록' ? '/admin/tbPortf/addTbPortf.do' : '/admin/tbPortf/updateTbPortf.do'}"/>";
    frm.submit();
...
<form:form modelAttribute="tbPortfVO" name="detailForm" id="detailForm" >
<div id="content_pop">
	<!-- 타이틀 -->
	<div id="title">
		<ul>
	...
	<table width="100%" border="1" cellpadding="0" cellspacing="0" >
		...
		<%-- <tr>
			<th>PORTF_SEQ</th>
			<td>
				<form:input path="portfSeq" cssClass="txt"/>
				&nbsp;<form:errors path="portfSeq" />
			</td>
		</tr>	
		<tr>
			<th>MEM_SEQ</th>
